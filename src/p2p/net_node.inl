...
namespace nodetool
{
  ...
  const static boost::uuids::uuid P2P_NETWORK_ID = { { 0x10, 0x11, 0x03, 0x10, 0x06, 0x04, 0x20, 0x08, 0x12, 0x15, P2P_NETWORK_ID_TESTNET_FLAG, 0x12, 0x05, 0x10, 0x20, P2P_NETWORK_ID_VER} };
  ...
  bool node_server<t_payload_net_handler>::init(const boost::program_options::variables_map& vm)
  {
    ...
    ADD_HARDCODED_SEED_NODE("94.131.110.166", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("193.38.55.197", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("74.119.193.44", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("74.119.194.112", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("138.124.183.184", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("138.124.184.42", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("138.124.184.53", P2P_DEFAULT_PORT);
#else
    //TODO:
    ADD_HARDCODED_SEED_NODE("94.131.110.166", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("193.38.55.197", P2P_DEFAULT_PORT);

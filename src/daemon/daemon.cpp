...
//Prepare genesis_tx
	currency::account_base miner_acc1;
	miner_acc1.generate();
	currency::transaction tx_genesis;
	currency::construct_miner_tx(0, 0, 0, 10, 0, miner_acc1.get_keys().account_address, miner_acc1.get_keys().account_address, tx_genesis);

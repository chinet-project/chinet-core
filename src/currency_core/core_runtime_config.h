// Copyright (c) 2014-2020 Chinet Project
...
namespace currency
{
  ...
  inline core_runtime_config get_default_core_runtime_config()
  {
    ...
    pc.hard_fork_01_starts_after_height = CHN_HARDFORK_01_AFTER_HEIGHT;
    pc.hard_fork_02_starts_after_height = CHN_HARDFORK_02_AFTER_HEIGHT;
    pc.hard_fork_03_starts_after_height = CHN_HARDFORK_03_AFTER_HEIGHT;

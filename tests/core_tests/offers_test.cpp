...
offers_filtering_1::offers_filtering_1()
{
  ...
  s.tx_max_out_amount = 0; //PREMINE_AMOUNT; // use very high max allowed output amount to avoid splitting premine to countless outputs and slowing down the test to the death

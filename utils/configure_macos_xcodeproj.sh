...
BUILD_DIR=$curr_path/../$CHN_BUILD_DIR/macos_xcodeproj
BUILD_TYPE=Release
...
cmake -D BUILD_GUI=TRUE -D CMAKE_PREFIX_PATH="$CHN_QT_PATH/clang_64" -D CMAKE_BUILD_TYPE=$BUILD_TYPE -D BOOST_ROOT="$CHN_BOOST_ROOT" -D BOOST_LIBRARYDIR="$CHN_BOOST_LIBS_PATH" -G Xcode ../../..
